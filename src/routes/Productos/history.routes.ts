...
router.post('/historial', schemaValidation(postHistorySchema) , InsertRow('historial') );
router.put('/historial/:idHistorial', schemaValidation(updateHistorySchema) , UpdateRow('historial') );
router.delete('/historial/:idHistorial', schemaValidation(deleteHistorySchema) , deleteRow('historial') );
